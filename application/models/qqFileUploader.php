...
class qqFileUploader {
 ...
 print_r($_FILES);
      ...
      //if(empty($filename)){
        ...
        $allowedExtensions = array('png', 'jpg', 'jpeg', 'gif', 'bmp', 'JPG', 'BMP', 'GIF', 'PNG');
        ...
        if ($this->file->save($uploadDirectory . '/' . $filename)){
                $CI = & get_instance();
                $CI->load->model('UploadImages');
                $CI->UploadImages->productimage($filename , $_REQUEST['edit'],  $_SERVER['DOCUMENT_ROOT'] . '/public/uploads/products/' . $filename,  $_REQUEST['idx']);
